...
export const CORE_TOOL_CATALOG: ToolDescriptor[] = [
    ...
    // Trading — mercado, análisis técnico, paper trading, testnet y backtesting
    { name: "market_ticker", description: "Get current crypto price and 24h stats for a symbol: last, bid, ask, volume, percent change. Spanish keywords: precio de bitcoin, cotización, cuánto vale, a cómo está, precio actual, valor de la moneda", category: "trading", abstractionLevel: "atomic" },
    { name: "market_ohlcv", description: "Get candlestick (OHLCV) series for a crypto symbol across timeframes. Input for indicators and backtests. Spanish keywords: velas, gráfico de precios, histórico de precios, candlestick, datos históricos", category: "trading", abstractionLevel: "atomic" },
    { name: "market_orderbook", description: "Get L2 order book depth with bids, asks and spread for a crypto symbol. Spanish keywords: libro de órdenes, profundidad, order book, liquidez, spread, oferta y demanda", category: "trading", abstractionLevel: "atomic" },
    { name: "market_trades", description: "Get recent executed trades with buy and sell volume for a crypto symbol. Spanish keywords: operaciones recientes, trades, flujo de órdenes, presión compradora, quién está comprando", category: "trading", abstractionLevel: "atomic" },
    { name: "market_symbols", description: "List or search available markets on a crypto exchange. Use when the exact symbol is unknown. Spanish keywords: buscar par, qué símbolos hay, mercados disponibles, existe el par, listar monedas", category: "trading", abstractionLevel: "atomic" },
    { name: "market_funding", description: "Get funding rate and open interest for a perpetual futures contract. Spanish keywords: funding rate, tasa de financiación, interés abierto, perpetuos, apalancamiento del mercado", category: "trading", abstractionLevel: "atomic" },
    { name: "ta_indicators", description: "Compute technical indicators on crypto candles: RSI, MACD, EMA, SMA, Bollinger Bands, ATR, VWAP. Wilder smoothing matches TradingView. Spanish keywords: rsi, macd, medias móviles, bollinger, indicadores, análisis técnico, sobrecomprado, sobrevendido", category: "trading", abstractionLevel: "atomic" },
    { name: "ta_levels", description: "Detect support and resistance levels from fractal pivots, clustered by proximity. Spanish keywords: soportes, resistencias, niveles, zonas clave, dónde rebota, techo y piso", category: "trading", abstractionLevel: "atomic" },
    { name: "scan_markets", description: "Screen crypto markets by 24h volume and percent change to find what is moving. Spanish keywords: screener, qué se está moviendo, mayores subidas, top ganadores, más volumen, qué comprar", category: "trading", abstractionLevel: "composite" },
    { name: "arbitrage_scan", description: "Compare the same crypto symbol price across exchanges and compute the gross spread. Spanish keywords: arbitraje, diferencia de precio entre exchanges, spread entre casas, dónde está más barato", category: "trading", abstractionLevel: "composite" },
    { name: "paper_account", description: "Create or read the simulated paper trading account: balance, equity, open positions, total return. Spanish keywords: cuenta demo, portafolio simulado, saldo virtual, cuánto tengo, mi cuenta, mi portafolio", category: "trading", abstractionLevel: "atomic" },
    { name: "paper_order", description: "Execute a SIMULATED market order against the real order book. Never touches real funds. Fill includes real slippage. Spanish keywords: comprar simulado, vender simulado, orden de prueba, paper trade, abrir posición, invertir simulado", category: "trading", abstractionLevel: "atomic" },
    { name: "paper_positions", description: "List open simulated positions with unrealized PnL marked to market. Spanish keywords: mis posiciones, qué tengo abierto, ganancia no realizada, cómo van mis trades", category: "trading", abstractionLevel: "atomic" },
    { name: "paper_close", description: "Close a simulated position at market against the real book and report realized PnL. Spanish keywords: cerrar posición, vender todo, liquidar, salir de la posición, tomar ganancias", category: "trading", abstractionLevel: "atomic" },
    { name: "paper_history", description: "Get simulated trade history with metrics: win rate, total PnL, profit factor, max drawdown. Spanish keywords: historial, resultados, estadísticas, cómo me fue, win rate, mis operaciones, rendimiento", category: "trading", abstractionLevel: "atomic" },
    { name: "exchange_balance", description: "Read account balance on the exchange TESTNET. Requires testnet mode and testnet keys; never reads production. Spanish keywords: saldo en el exchange, balance de la cuenta, cuánto hay en binance", category: "trading", abstractionLevel: "atomic" },
    { name: "exchange_order", description: "Place an order on the exchange TESTNET with test funds, never real money. Passes whitelist and max notional guardrails. Spanish keywords: orden en testnet, colocar orden, comprar en el exchange de prueba", category: "trading", abstractionLevel: "atomic" },
    { name: "exchange_orders", description: "List or cancel open orders on the exchange TESTNET. Spanish keywords: órdenes abiertas, cancelar orden, qué tengo pendiente en el exchange", category: "trading", abstractionLevel: "atomic" },
    { name: "trading_chart", description: "Draw a candlestick chart, optionally with RSI, into the user's interactive panel. Use it when a picture explains better than a paragraph: market structure, a level breaking, a divergence. Spanish keywords: dibuja el gr\u00e1fico, mu\u00e9strame las velas, gr\u00e1fica de, ver el chart", category: "trading", abstractionLevel: "atomic" },
    { name: "trading_focus", description: "Point the user's trading screen at a symbol, optionally with a timeframe and support/resistance levels drawn on the chart. Does not return market data \u2014 it only directs the view. Spanish keywords: mu\u00e9strame, enfoca, abre el gr\u00e1fico de, ponme en pantalla, ver el gr\u00e1fico", category: "trading", abstractionLevel: "atomic" },
    { name: "backtest_run", description: "Backtest a strategy on historical crypto candles (moving average cross or RSI threshold) and compare against buy and hold. Spanish keywords: backtest, probar estrategia, simular histórico, qué habría pasado, validar idea, funciona la estrategia", category: "trading", abstractionLevel: "composite" },
    // Cron tools (cron.*)
