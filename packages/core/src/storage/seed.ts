...
export const SEED_DATA: SeedData = {
  tools: [
    ...
    { id: "trading_chart", name: "trading_chart", category: "trading", description: "Dibujar un gr\u00e1fico de velas con RSI en el Panel interactivo del usuario. Sin\u00f3nimos: dibuja el gr\u00e1fico, mu\u00e9strame las velas, gr\u00e1fica de, ver el chart" },
    { id: "trading_focus", name: "trading_focus", category: "trading", description: "Dirigir la pantalla de trading a un s\u00edmbolo, con temporalidad y niveles marcados. Sin\u00f3nimos: mu\u00e9strame, enfoca, abre el gr\u00e1fico de, ponme en pantalla" },
